...
enum RailResult {
    ...
    // kErrorNetChannelInitializeFailed = 2001,       // not used.
    // kErrorNetChannelMemberOnline = 2002,           // not used.
    // kErrorNetChannelMemberOffline = 2003,          // not used.
    // kErrorNetChannelServerTimout = 2004,           // not used.
    // kErrorNetChannelServerException = 2005,        // not used.
    // kErrorNetChannelChannelIsAlreadyExist = 2006,  // not used.
    // kErrorNetChannelChannelIsNotExist = 2007,      // not used.
    // kErrorNetChannelNoAvailableDataToRead = 2008,  // not used.
    ...
    // kErrorRoomServerRoomGroupFull = 3017,        // not used.
    ...
    kErrorUserSpaceDownloadError = 13002,        // failed to download at least one file of
                                                 // spacework.
    ...
    kErrorUserSpaceGetTicketFailed = 13014,  // can not get ticket when uploading, usually
                                             // network issues.
    kErrorUserSpaceVersionOccupied = 13015,  // new version value must not equal to the last
                                             // version.
    kErrorUserSpaceCallCreateMethodFailed = 13016,  // facing network issues when create a
                                                    // spacework.
    kErrorUserSpaceCreateMethodRspFailed = 13017,   // server failed to create a spacework.
    // kErrorUserSpaceGenerateDescFileFailed = 13018,  // not used
    // kErrorUserSpaceUploadFailed = 13019,            // not used
    ...
    kErrorUserSpaceEditMethodRspFailed = 13022,    // server failed to commit changes of a
                                                   // spacework.
    kErrorUserSpaceMetadataHasInvalidKey = 13023,  // the key of metadata should not start
                                                   // with Rail_(case insensitive).
    kErrorUserSpaceModifyFavoritePartialSuccess = 13024,  // not all (un)favorite operations
                                                          // success.
    ...
    kErrorNetworkConnectionClosed = 15008,       // connected session has been closed by remote
                                                 // peer.
    ...
    // in-game coin
    kErrorInGameCoin = 26000,
    kErrorInGameCoinCreatePaymentBrowserFailed = 26001,  // create payment browser failed.
    kErrorInGameCoinOperationTimeout = 26002,  // operation time out.
    kErrorInGameCoinPaymentFailed = 26003,     // payment is failed.
    kErrorInGameCoinPaymentCanceled = 26004,   // payment is canceled.
