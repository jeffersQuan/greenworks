...
class IRailFriends {
  public:
    ...
    // @desc Synchronously get the friends list for the current player. Once the game client is started,
    // the friends list will be automatically updated. When the update is done, you 
    // will receive the callback RailFriendsListChanged or the result kErrorFriendsServerBusy.
