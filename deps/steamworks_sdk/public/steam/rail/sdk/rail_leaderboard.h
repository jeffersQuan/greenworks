...
class IRailLeaderboardHelper {
  public:
    ...
    // Developer Portal nor created with this interface earlier, the call will create one. Otherwise,
    // the existing leaderboard will be opened just like using OpenLeaderboard
...
class IRailLeaderboardEntries : public IRailComponent {
  public:
    ...
    // @param param See definition of RequestLeaderboardEntryParam for details
    // @param user_data Will be copied to the asynchronous result
    // @return Returns kSuccess on success
