...
// To use the APIs, you will first need to configure meta data for game achivements on developer
// portal. The APIs can only be used for achievements already submitted on developer portal.
// Below are 3 main scenarios
// 1) Unlock achievement for the current player
// 2) Check another player's achievement status.
...
class IRailAchievementHelper {
  public:
    // @desc Create an object for player achievement
